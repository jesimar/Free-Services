...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Página Beautify URL - Error" />
		...
		<div class="container">
			<form class="form-signin align-middle">
				...
				<div class="text-center mb-4">
					...
					<p style="color: red;">Erro - A URL utilizada não existe</p>
				</div>

				<a href="index.php" class="btn btn-lg btn-primary btn-block"><i class="fas fa-arrow-circle-left"></i> &nbsp; Voltar</a>
